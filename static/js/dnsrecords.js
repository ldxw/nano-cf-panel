...
$(document).ready(function(){
    y_wait="<img src='https://cdn.jsdelivr.net/gh/ldxw/nano-cf-panel/static/img/proxied_y.svg'  type='image/svg+xml' data-proxied='true' class='proxy_wait_for_ajax btn btn-sm-diy' />";
    n_wait="<img src='https://cdn.jsdelivr.net/gh/ldxw/nano-cf-panel/static/img/proxied_n.svg'  type='image/svg+xml' data-proxied='false' class='proxy_wait_for_ajax btn btn-sm-diy' />";
    y="<img src='https://cdn.jsdelivr.net/gh/ldxw/nano-cf-panel/static/img/proxied_y.svg'  type='image/svg+xml' data-proxied='true' class='proxy btn btn-sm-diy' />";
    n="<img src='https://cdn.jsdelivr.net/gh/ldxw/nano-cf-panel/static/img/proxied_n.svg'  type='image/svg+xml' data-proxied='false' class='proxy btn btn-sm-diy' />";
...
//function for loading the CNAME detial that was setted at the CloudFlare Partner
    ...
    error:function(XMLHttpRequest, textStatus, errorThrown){
          ...
          $('.current_zone img').attr('src', 'https://cdn.jsdelivr.net/gh/ldxw/nano-cf-panel/static/img/select.svg');
      },
      });
      }
    });
...
$("#table_body").on("click",".add_proxy",function(){
     ...
     if($(this).attr("data-proxied")=="true"){
          $(this).remove();
          parent.html("<img src='https://cdn.jsdelivr.net/gh/ldxw/nano-cf-panel/static/img/proxied_n.svg'  type='image/svg+xml' data-proxied='false' class='add_proxy btn btn-sm-diy' />");
     }else{
          $(this).remove();
          parent.html("<img src='https://cdn.jsdelivr.net/gh/ldxw/nano-cf-panel/static/img/proxied_y.svg'  type='image/svg+xml' data-proxied='true' class='add_proxy btn btn-sm-diy' />");
     }
});
